    ...
    , ui(new Ui::MainWindow)
{
    ...
    setStatusBar(staBar);
    QLabel * statusLab = new QLabel("广播地址为：192.168.222.255",this);
    staBar->addWidget(statusLab);
    QLabel * rstaLab = new QLabel("当前速度2MB/S",this);
    staBar->addPermanentWidget(rstaLab);
}
